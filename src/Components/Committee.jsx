                            ...
                            <div className="flex items-start mb-6">
                                ...
                                <div className="items-end">
                                    <ul className="lg: py-6">
                                        ...
                                        <li className="text-[12px] flex flex-col items-start py-1 px-2"> <p className=' text-[16px] font-bold'><a href="" className="href">Dr. Nabendu Ghosh</a> </p>Assistant Professor, Jadavpur University</li>
                                        ...
                                        <li className="text-[12px] flex flex-col items-start py-1 px-2"> <p className=' text-[16px] font-bold'><a href="" className="href">Dr. Santosh Kumar</a> </p>Research Scholar, Jadavpur University</li>
                                        ...
                                        <li className="text-[12px] flex flex-col items-start py-1 px-2"> <p className=' text-[16px] font-bold'><a href="" className="href">Dr. B. Mouli Prasanth</a> </p>Post Doctoral Researcher, Shandog Universiy, China</li>
                                        ...
                                        <li className="text-[12px] flex flex-col items-start py-1 px-2"> <p className=' text-[16px] font-bold'><a href="" className="href">Dr. Ataur Safi Rahaman</a> </p>Assistant Professor, TPO cell, Swami Vivekananda Institute of Science and Technology</li>
                                        <li className="text-[12px] flex flex-col items-start py-1 px-2"> <p className=' text-[16px] font-bold'><a href="" className="href">Mr. Bikash Banerjee</a> </p>Assistant Professor, Veer Surendra Sai University and Technology, Burla, Odisha</li>
                                        ...
                                        <li className="text-[12px] flex flex-col items-start py-1 px-2"> <p className=' text-[16px] font-bold'><a href="" className="href">Dr. Swarup Pal</a> </p>Assistant Professor, NIT Agartala</li>
                                        ...
                                        <li className="text-[12px] flex flex-col items-start py-1 px-2"> <p className=' text-[16px] font-bold'><a href="" className="href">Dr. Suman Nihar</a> </p>Assistant Professor, Jadavpur University</li>
