...
const Committee =()=>{
    return(
        <div id="Committee" className="lg:py-2">
                ...
                <h2 className="text-[22px] lg:px-10 py:5">Conveners:
                    <ul className="">                    
                ...
                <h2 className="text-[22px] lg:px-10 py:5">Organising Secretaries:
                    <ul>
                ...
                <h2 className="text-[22px] lg:px-10 py:5">Conference Coordinators:
                    <ul className="">
                ...
                <h2 className="text-[22px] lg:px-10 py:5">Treasurers:
                        <ul className="">
                ...
                <h2 className="text-[22px] lg:px-10 py:5">IT Support:
                    <ul className="">
                        <li className="text-[18px] lg:px-5 text-gray-600">Mr. Arindam Chakraborty, Assistant Professor, SVIST</li>
                    </ul>
